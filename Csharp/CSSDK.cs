...
namespace InteroperabilityWrapperRnet
{    
    public static class InteroperabilityWrapperRnet
    {
        ...
        public static string FetchForDotnet(
            string paramsJson
        ) {
            return _FreeStr(_FnFetchForDotnet(_AllocStr(paramsJson)));
        }
        [DllImport("interoperability_wrapper_rnet", EntryPoint = "rnet_export_fetch_for_dotnet", CallingConvention = CallingConvention.Cdecl)]
        private static extern _RawSlice _FnFetchForDotnet(
            _RawSlice paramsJson
        );
        ...
        [DllImport("interoperability_wrapper_rnet", EntryPoint = "rnet_alloc", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr _Alloc( UIntPtr size, UIntPtr align);

        [DllImport("interoperability_wrapper_rnet", EntryPoint = "rnet_free", CallingConvention = CallingConvention.Cdecl)]
